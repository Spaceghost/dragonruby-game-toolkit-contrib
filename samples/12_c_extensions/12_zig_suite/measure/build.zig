...
pub fn build(b: *std.Build) void {
    ...
    if (mruby) |root| {
        ...
        const query = library(b, "measure_query_sqlite", "../sqlite/query.zig", target, optimize);
        query.root_module.addIncludePath(path(b, "../sqlite"));
        ...
        const query_c = object(b, "measure-query-c", path(b, "query_control.c"), target, optimize, &common, null);
